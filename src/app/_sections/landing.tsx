...
export const Landing = () => {
  ...
  return (
    ...
    >
      ...
      <div className='mb-0 grid lg:mb-0 lg:w-full lg:px-32 grid-cols-4 text-left'>
      ...
      <div className='absolute bg-contain bg-no-repeat w-[640px] h-full right-28 bg-purple-composition -z-30'></div>
